...
mod tests {
    ...
    fn test_ollama_check_request_deserialization() {
        ...
        let request: OllamaCheckRequest = serde_json::from_str(json).expect("Deserialization should succeed");
    ...
    fn test_ollama_check_request_roundtrip_serialization() {
        ...
        let deserialized: OllamaCheckRequest = serde_json::from_str(&serialized).expect("Deserialization should succeed");
