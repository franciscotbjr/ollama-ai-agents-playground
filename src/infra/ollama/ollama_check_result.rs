...
mod tests {
    ...
    fn test_ollama_check_result_deserialization_true() {
        ...
        let result: OllamaCheckResult = serde_json::from_str(json).expect("Deserialization should succeed");
    ...
    fn test_ollama_check_result_roundtrip_serialization() {
        ...
        let deserialized: OllamaCheckResult = serde_json::from_str(&serialized).expect("Deserialization should succeed");
